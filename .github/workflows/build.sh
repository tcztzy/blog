...
if [ "$book_lang" = "en" ]; then
    ...
    # Back-date the sources to POT-Creation-Date.
    # echo "::group::Building clean up src/"
    # rm -r src/
    # echo "::group::Building restore the src/ directory to the state of $pot_creation_date"
    ...
    export MDBOOK_OUTPUT__HTML__SITE_URL=/blog/$book_lang/
